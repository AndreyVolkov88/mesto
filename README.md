...
9. Использование media queries для задания специфических правил, для разных экранов.
10. Публикация проекта с помощью сервиса ["GitHub Pages"](https://pages.github.com/).
11. Использование java-script.
12. Использование объектов в JavaScript-коде для освоения принципов ООП;
13. Использование модулей для организации JavaScript-кода;
14. Создание и настройка форм для фильтрации данных и помощи пользователю.
15. Использование сборщика проектов Webpack.
